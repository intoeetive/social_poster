...
class Social_poster {
    ...
    function permissions()
    {
        ...
        {
            $enabled_by_default[$provider] = (isset($settings[$site_id][$provider]['post_by_default']))?$settings[$site_id][$provider]['post_by_default']:'y';
        }
    ...
    function save_permissions()
    {
        ...
        foreach ($SLP->providers as $provider)
        {
            ...
            {
                $permissions[$site_id][$provider] = (isset($settings[$site_id][$provider]['post_by_default']))?$settings[$site_id][$provider]['post_by_default']:'n';
            }
        }
